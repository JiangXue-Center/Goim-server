...
type GatewayGetUserConnectionResp struct {
	...
	Header      *ResponseHeader   `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	Connections []*LongConnection `protobuf:"bytes,2,rep,name=connections,proto3" json:"connections,omitempty"`
}
...
type GatewayGetConnectionByFilterReq struct {
	...
	Header *RequestHeader              `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	Filter *GatewayGetConnectionFilter `protobuf:"bytes,2,opt,name=filter,proto3" json:"filter,omitempty"`
}
...
type GatewayWriteDataToWsReq struct {
	...
	Header *RequestHeader              `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	Filter *GatewayGetConnectionFilter `protobuf:"bytes,2,opt,name=filter,proto3" json:"filter,omitempty"`
	Data   *GatewayWriteDataContent    `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
type GatewayWriteDataToWsResp struct {
	...
	Header             *ResponseHeader   `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	SuccessConnections []*LongConnection `protobuf:"bytes,2,rep,name=successConnections,proto3" json:"successConnections,omitempty"`
}
